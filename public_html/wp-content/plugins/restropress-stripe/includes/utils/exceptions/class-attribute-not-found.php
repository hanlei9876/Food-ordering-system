<?php
/**
 * RPRESS_Stripe_Utils_Exceptions_Attribute_Not_Found exception class
 *
...
/**
 * Implements an RPRESS_Stripe_Utils_Exceptions_Attribute_Not_Found exception thrown when a given
 ...
 */
class RPRESS_Stripe_Utils_Exceptions_Attribute_Not_Found extends OutOfBoundsException {
	 ...
	 *                                   Default null.
	 * @return RPRESS_Stripe_Exceptions_Attribute_Not_Found Exception instance.
	 */

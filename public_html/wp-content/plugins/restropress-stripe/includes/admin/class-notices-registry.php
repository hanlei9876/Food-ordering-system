 ...
 * @since 1.1
 */
class RPRESS_Stripe_Admin_Notices_Registry extends RPRESS_Stripe_Utils_Registry implements RPRESS_Stripe_Utils_Static_Registry {
	 ...
	 * @since 1.1
	 *
	 * @return RPRESS_Stripe_Admin_Notices_Registry Report registry instance.
	 */
	public static function instance() {
		if ( is_null( self::$instance ) ) {
			self::$instance = new RPRESS_Stripe_Admin_Notices_Registry();
		}
	...
	public function init() {
		 ...
		 * @since 1.1
		 *
		 * @param RPRESS_Stripe_Notices_Registry $this Registry instance.
		 */
		do_action( 'rpress_stripe_admin_notices_registry_init', $this );
	}
	...
	public function add( $notice_id, $notice_args ) {
		...
		if ( empty( $notice_args['message'] ) ) {
			throw new Exception( esc_html__( 'A message must be specified for each notice.', 'rpstripe' ) );
		}

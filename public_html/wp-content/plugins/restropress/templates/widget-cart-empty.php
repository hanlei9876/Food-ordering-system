...
<?php if( apply_delivery_fee() ) : ?>
  <li class="cart_item rpress-cart-meta rpress_subtotal" style="display:none;"><?php _e( 'SubTotal:', 'restropress' ); ?> <span class="cart-sub-total <?php echo $color; ?>"><?php echo rpress_currency_filter( rpress_format_amount( rpress_get_cart_subtotal() ) ); ?></span>
  </li>
<?php endif; ?>

<?php if ( get_delivery_fees() > 0 ) : ?>
  <li class="cart_item rpress-cart-meta rpress_delivery_fee" style="display:none;"><?php _e( 'Fee:', 'restropress' ); ?> <span class="rpress-delivery-fee <?php echo $color; ?>"><?php echo rpress_currency_filter( rpress_format_amount( get_delivery_fees() ) ); ?></span>
<?php endif; ?>

<li class="cart_item rpress-cart-meta rpress_total 999" style="display:none;"><?php _e( 'Total (', 'restropress' ); ?><span class="rpress-cart-quantity" <?php echo $display; ?>><?php echo $cart_quantity; ?></span> <?php _e( ' Items)', 'restropress' ); ?><span class="cart-total <?php echo $color; ?>"><?php echo rpress_currency_filter( rpress_format_amount( rpress_get_cart_total() ) ); ?></span></li>

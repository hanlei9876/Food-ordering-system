...
<table id="rpress_purchase_receipt" class="rpress-table">
	...
	<tbody>
		...
		<?php if ( !empty( $delivery_date ) ) : ?>
			<tr>
				<td class="rpress_receipt_delivery_date"><strong><?php _e( 'Delivery Date', 'restropress' ); ?>:</strong></td>
		...
		<?php if ( !empty( $order_note ) ) : ?>
			<tr>
			<td class="rpress_order_note"><strong><?php _e( 'Order Note', 'restropress' ); ?>:</strong></td>
			<td class="rpress_order_note"><?php echo $order_note; ?></td>
		</tr>
		<?php endif; ?>

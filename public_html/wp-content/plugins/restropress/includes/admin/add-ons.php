				...
				<div class="rp-col-xs-12 rp-col-sm-6 rp-col-md-5 rp-col-lg-5 restropress-addon-img-wrap">
					<div class="inside">
						...
						<div class="restropress-btn-group rpress-purchase-section">
							...
							<a class="button button-medium button-primary " target="_blank" href="<?php echo $item_link . '?utm_source=plugin&utm_medium=addon_page&utm_campaign=promote_addon' ?>" ><?php esc_html_e( 'Details', 'restropress')?></a>
						</div>
						...
						<div class="restropress-btn-group rpress-addon-details-section pull-left">
							<a class="button button-medium button-primary " target="_blank" href="<?php echo $item_link . '?utm_source=plugin&utm_medium=addon_page&utm_campaign=promote_addon' ?>" ><?php echo __('Details', 'restropress')?></a>
						</div>

					...
					<div id="postbox-container-1" class="postbox-container">
                      ...
                      <p>
                        ...
                        <?php 
                          ...
                          $order_status_help .= '<li>' . __( '<strong>Pending</strong>: Order is in pending status', 'restropress' ) . '</li>';
                        $order_status_help .= '<li>' . __( '<strong>Processing</strong>: Order has been processed.', 'restropress' ) . '</li>';
                        $order_status_help .= '<li>' . __( '<strong>Cancelled</strong>: Order has been cancelled', 'restropress' ) . '</li>';
                        $order_status_help .= '<li>' . __( '<strong>Delivered</strong>: Payment has been done and the order has been delivered.', 'restropress' ) . '</li>';
                          $order_status_help .= '</ul>';
                        ?>
								...
								<div class="rpress-order-update-box rpress-admin-box">
									...
									<div id="major-publishing-actions">
										<div id="delete-action">
											<a href="<?php echo wp_nonce_url( add_query_arg( array( 'rpress-action' => 'delete_payment', 'purchase_id' => $payment_id ), admin_url( 'edit.php?post_type=fooditem&page=rpress-payment-history' ) ), 'rpress_payment_nonce' ) ?>" class="rpress-delete-payment rpress-delete"><?php _e( 'Delete Order', 'restropress' ); ?></a>
										</div>
                      ...
                      <div class="rpress-delivery-details rpress-admin-box-inside">
                        <p>
                          ...
                          ?>
										...
										<?php do_action( 'rpress_order_details_after', $payment_id ); ?>
							...
							<div id="rpress-order-details" class="postbox rpress-order-data">
								...
								<div class="inside">
									<div class="rpress-admin-box">
										...
										<div class="rpress-order-tx-id rpress-admin-box-inside">
											<p>
												<span class="label"><?php _e( 'Order Note:', 'restropress' ); ?></span>&nbsp;
												<span><?php echo $order_note; ?></span>
											</p>
										</div>
										<?php endif; ?>

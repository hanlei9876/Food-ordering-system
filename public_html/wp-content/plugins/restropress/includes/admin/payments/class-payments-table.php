...
<?php
	...
	public function get_views() {
		...
		$views = array(
			...
			// 'publish'    => sprintf( '<a href="%s"%s>%s</a>', add_query_arg( array( 'status' => 'publish', 'paged' => FALSE ) ), $current === 'publish' ? ' class="current"' : '', __('Paid','restropress' ) . $paid_count ),
	...
	public function get_bulk_actions() {
		$actions = array(
			...
			'set-status-failed'      => __( 'Set To Failed',         'restropress' ),

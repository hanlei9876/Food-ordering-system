 ...
 * @global $rpress_extensions_page
 * @global $rpress_settings_export
 * @return void
 */
function rpress_add_options_link() {
	global $rpress_discounts_page, $rpress_payments_page, $rpress_settings_page, $rpress_reports_page, $rpress_extensions_page, $rpress_settings_export, $rpress_tools_page, $rpress_delivery_page, $rpress_customers_page;
	...
	$rpress_customers_page     = add_submenu_page( 'edit.php?post_type=fooditem', __( 'Customers', 'restropress' ), __( 'Customers', 'restropress' ), $customer_view_role, 'rpress-customers', 'rpress_customers_page' );
	$rpress_discounts_page     = add_submenu_page( 'edit.php?post_type=fooditem', __( 'Discount Codes', 'restropress' ), __( 'Discount Codes', 'restropress' ), 'manage_shop_discounts', 'rpress-discounts', 'rpress_discounts_page' );
	$rpress_reports_page       = add_submenu_page( 'edit.php?post_type=fooditem', __( 'Earnings and Sales Reports', 'restropress' ), __( 'Reports', 'restropress' ), 'view_shop_reports', 'rpress-reports', 'rpress_reports_page' );
	...
	$rpress_extensionss_page       = add_submenu_page( 'edit.php?post_type=fooditem', __( 'RestroPress Extensions', 'restropress' ), '<span style="color:#f39c12;">' . __( 'Extensions', 'restropress' ) . '</span>', 'manage_shop_settings', 'rpress-extensions', 'rpress_extensions_page' );
...
function rpress_is_admin_page( $passed_page = '', $passed_view = '' ) {
	...
	switch ( $passed_page ) {
		...
		case 'reports':
			...
			break;
		default:
			global $rpress_discounts_page, $rpress_payments_page, $rpress_settings_page, $rpress_reports_page, $rpress_system_info_page, $rpress_settings_export, $rpress_customers_page, $rpress_extensions_page, $rpress_reports_page;
			$admin_pages = apply_filters( 'rpress_admin_pages', array( $rpress_discounts_page, $rpress_payments_page, $rpress_settings_page, $rpress_extensions_page, $rpress_reports_page, $rpress_system_info_page,  $rpress_settings_export, $rpress_customers_page, $rpress_reports_page ) );

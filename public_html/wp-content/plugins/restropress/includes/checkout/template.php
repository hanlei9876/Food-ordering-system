...
?>
			<div id="rpress_checkout_form_wrap" class="rp-col-lg-8 rp-col-md-8 rp-col-sm-12 rp-col-xs-12 ">
...
function rpress_terms_agreement() {
	...
	?>
		<fieldset id="rpress_terms_agreement">
			...
			<?php 
			if ( '1' !== rpress_get_option( 'show_agree_to_privacy_policy', false ) && '1' === rpress_get_option( 'show_privacy_policy_on_checkout', false ) ) : ?>
				<?php
